...
APPSERVICE_QUARKUS_UBUNTU_NATIVE_APP="app-quarkus-ubuntu-native"
...
APP_INSIGHTS_APPSERVICE_QUARKUS_UBUNTU_NATIVE_APP="appi-$APPSERVICE_QUARKUS_UBUNTU_NATIVE_APP"
...
CONTAINER_QUARKUS_UBUNTU_NATIVE_IMAGE="${PROJECT}/quarkus-ubuntu-native:${IMAGES_TAG}"
